# Latency benchmark: public_sat_rnnt
...
- ASR decoding: {'hi': 'ctc', 'sat': 'rnnt'}; trim silence: {'hi': True, 'sat': False}; NMT engine: onnx-fp32
- Server boot (all models loaded): 19.0 s
- Cold request (first after boot, sat): 3964 ms
...
|---|---|---|---|---|---|---|---|---|
| sat-to-hi | 79 | 2195 | 2614 | 3252 | 1020 | 883 | 320 | 0.067 |
