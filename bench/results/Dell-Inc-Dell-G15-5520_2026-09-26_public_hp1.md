...
- Server boot (all models loaded): 29.9 s
- Cold request (first after boot, hi): 7111 ms
...
|---|---|---|---|---|---|---|---|---|
| hi-to-sat | 79 | 2263 | 2867 | 3545 | 877 | 947 | 457 | 0.024 |
| sat-to-hi | 80 | 2209 | 2596 | 3477 | 969 | 876 | 362 | 0.072 |
...
|---|---|---|---|---|---|---|---|
| hi-to-sat | 79 | 2263 | 2867 | 3545 | 877 | 947 | 457 |
| sat-to-hi | 80 | 2209 | 2596 | 3477 | 969 | 876 | 362 |

Requests over 3 s: 8 of 159.
Translations answered by the model: 159 of 159 (the rest by the glossary or a cache).
TTS errors: 0.

Raw data: `Dell-Inc-Dell-G15-5520_2026-09-26_public_hp1.csv`.
